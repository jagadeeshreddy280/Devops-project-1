...
1.Go to manage jenkins--> plugins --> nomad

2.Go to manage jenkins --> clouds --> click nomad option --> save

![image](https://github.com/jagadeeshreddy280/Devops-project-1/assets/116871383/3183b5a6-26e9-431c-b4a6-493ba5893fdb)


3.copy nomad url and paste on Nomad API URL box --> test connection --> successfull
